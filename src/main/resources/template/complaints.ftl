...
<div class="container">
    ...
    <div class="content">
        <div class="pagination">
            <a href="/complaints?page=${page - 1}&name=${name!""}" class="pagination-btn left"
               style="visibility: ${left_visibility! 'hidden'};">&#8592; Назад</a>
            <a href="/complaints?page=${page + 1}&name=${name!""}" class="pagination-btn right"
        ...
        <section class="complaints-section">
            <div class="complaint-button-container">
                <a href="/create_complaint.ftl" class="create_complaint">Новая жалоба</a>
            </div>
            <h2>Мои жалобы</h2>
                    ...
                    <div class="complaint-item">
                        <a class="complaint-link">
                            <div class="complaint-content">
                                ...
                                <a class="complaint-text">${complaintItem.complaintText}</a>
                            </div>
                        </a>
                    </div>
                </#list>
